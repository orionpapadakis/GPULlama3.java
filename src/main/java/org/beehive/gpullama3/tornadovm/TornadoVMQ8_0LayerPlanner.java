...
public class TornadoVMQ8_0LayerPlanner<S extends State, C extends Configuration, W extends Q8_0Weights> implements TornadoVMGenericLayerPlanner {
     ...
     */
    public TornadoVMQ8_0LayerPlanner(S state, Model model) {
        this.state = state;
