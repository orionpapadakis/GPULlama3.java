...
public class Qwen3Q8_0TornadoVMLayerPlanner extends TornadoVMQ8_0LayerPlanner<Qwen3State, Qwen3Configuration, Qwen3Q8_0TornadoWeights>{
    ...
    public Qwen3Q8_0TornadoVMLayerPlanner(Qwen3State state, Model model) {
        super(state, model);
    ...
    public Tuple2<List<ImmutableTaskGraph>, GridScheduler> setupTornadoForwardPlanLayered() {
        ...
        for (int layerIndex =0; layerIndex < config.numberOfLayers(); layerIndex++) {
            ...
            unifiedLayer.task("matmul1", TransformerComputeKernelsLayered::matrixVectorGenericWithResidual,
                    ...
                    weights.woLayered[layerIndex].getQuants(),          // matrix
                    weights.woLayered[layerIndex].getScales(),
