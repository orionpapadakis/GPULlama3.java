...
import org.beehive.gpullama3.tornadovm.Qwen3Kernels;
import org.beehive.gpullama3.tornadovm.TornadoVMQ8_0LayerPlanner;
import org.beehive.gpullama3.tornadovm.TransformerComputeKernels;
import org.beehive.gpullama3.tornadovm.TransformerComputeKernelsLayered;
...
public class Qwen2Q8_0TornadoVMLayerPlanner extends TornadoVMQ8_0LayerPlanner<Qwen2State, Qwen2Configuration, Qwen2TornadoWeightsQ8_0> {
     ...
     */
    public Qwen2Q8_0TornadoVMLayerPlanner(Qwen2State state, Model model) {
        super(state, model);
    }
