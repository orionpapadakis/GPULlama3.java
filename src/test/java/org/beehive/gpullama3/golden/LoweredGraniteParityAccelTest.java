...
/**
 * The multiplying mode is the part worth having a device check for. A Granite program that divided
 * by the same number would pass every structural rule and compute a different model; only running
 * it against the legacy path shows that it does not.
 *
...
public class LoweredGraniteParityAccelTest {
    ...
    @Test
    public void graniteLowersAndReproducesTheLegacyLogitsExactly_q8_0() throws Exception {
        assertLoweredMatchesLegacy(Fixture.GRANITE_3_2_2B_Q8_0);
    }
